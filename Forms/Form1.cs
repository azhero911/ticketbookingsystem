...
namespace ticketbookingsystem
{
    public partial class Form1 : Form
    {
        ...
        void SetRoundedPanel(Panel panel, int radius)//round the panel but useless
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtuser.Text) || string.IsNullOrWhiteSpace(txtpass.Text))//check empty boxes
            {
        ...
        private void Form1_Load_1(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = label1;//the mouse control to label when form load
